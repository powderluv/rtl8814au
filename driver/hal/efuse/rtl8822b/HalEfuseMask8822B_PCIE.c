...
{
	return sizeof(Array_MP_8822B_MPCIE) / sizeof(EF1Byte);
}

VOID
EFUSE_GetMaskArray_MP_8822B_MPCIE(u8* Array)
{
	EF2Byte len = EFUSE_GetArrayLen_MP_8822B_MPCIE(), i = 0;
...
BOOLEAN
EFUSE_IsAddressMasked_MP_8822B_MPCIE(EF2Byte  Offset)
{
	int r = Offset / 16;
	int c = (Offset % 16) / 2;
	int result = 0;
